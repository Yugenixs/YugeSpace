    ...
    <section className="py-12 sm:py-16">
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6 reveal reveal-d2">
        <div className="bg-[var(--surface)] border-4 border-brutal rounded-xl brutal-shadow p-3 sm:p-5 flex items-center justify-center brutal-card card-glow">
          <img src="https://github-readme-stats.vercel.app/api?username=Yugenixs&show_icons=true&theme=radical&include_all_commits=true&count_private=true" alt="GitHub Stats" className="w-full max-w-sm" />
        </div>
        <div className="bg-[var(--surface)] border-4 border-brutal rounded-xl brutal-shadow p-3 sm:p-5 flex items-center justify-center brutal-card card-glow">
          <img src="https://github-readme-streak-stats.herokuapp.com/?user=Yugenixs&theme=radical" alt="GitHub Streak" className="w-full max-w-sm" />
        </div>
      </div>
      <div className="bg-[var(--surface)] border-4 border-brutal rounded-xl brutal-shadow p-3 sm:p-5 mt-4 sm:mt-6 flex items-center justify-center reveal reveal-d3 brutal-card card-glow">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Yugenixs&layout=compact&theme=radical&langs_count=6&count_private=true" alt="Top Languages" className="w-full max-w-md" />
      </div>
      <div className="bg-[var(--surface)] border-4 border-brutal rounded-xl brutal-shadow p-3 sm:p-5 mt-4 sm:mt-6 flex items-center justify-center reveal reveal-d4 brutal-card card-glow">
        <img src="https://ghchart.rshah.org/F62477/Yugenixs" alt="GitHub Contributions" className="w-full" />
      </div>
    </section>
  )
}
